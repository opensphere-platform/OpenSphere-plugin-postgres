    ...
    <clr-modal [(clrModalOpen)]="editorOpen" [clrModalClosable]="!saving">
      ...
      <div class="modal-body">
        ...
        <form clrForm clrLayout="vertical" class="pgpc-form" autocomplete="off">
          ...
          <clr-input-container class="pgpc-full"><label>변경 사유</label><input clrInput name="profileReason" [(ngModel)]="reason" minlength="8" required placeholder="운영 리소스 요구사항 변경 (8자 이상)" /><clr-control-helper>감사 기록에 남을 운영 목적을 8자 이상 입력합니다.</clr-control-helper></clr-input-container>
        </form>
