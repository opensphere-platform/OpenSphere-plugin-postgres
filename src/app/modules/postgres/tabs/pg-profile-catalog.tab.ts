    ...
    <clr-modal [(clrModalOpen)]="editorOpen" [clrModalClosable]="!saving">
      ...
      <div class="modal-body">
        ...
        <form clrForm clrLayout="vertical" class="pgpc-form" autocomplete="off">
          ...
          <ng-container *ngIf="kind === 'postgres'"><clr-input-container><label>PostgreSQL 버전</label><input clrInput name="profilePostgresVersion" [(ngModel)]="postgresVersion" placeholder="18" /></clr-input-container><clr-textarea-container class="pgpc-full"><label>postgresql.conf (한 줄에 key=value)</label><textarea clrTextarea name="profilePostgresqlConf" [(ngModel)]="postgresqlConf" placeholder="max_connections=200&#10;wal_compression=on"></textarea></clr-textarea-container></ng-container>
