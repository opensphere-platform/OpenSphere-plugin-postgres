...
const BACKBLAZE_LOGO = 'data:image/png;base64,';
const CEPH_LOGO = 'data:image/png;base64,';
...
@Component({
  ...
  styles: [`
    ...
    .pgpc-target-logo { display:grid; place-items:center; width:1.75rem; height:1.75rem; color:#6f6f6f; }.pgpc-target-logo img { width:1.35rem; height:1.35rem; object-fit:contain; }
    ...
    .pgpc-form { display:grid; grid-template-columns:repeat(2,minmax(0,1fr)); gap:.7rem 1rem; align-items:start; padding-top:.1rem; }.pgpc-form clr-input-container,.pgpc-form clr-select-container,.pgpc-form clr-textarea-container,.pgpc-form clr-checkbox-container { min-width:0; margin:0; }.pgpc-form input[clrInput],.pgpc-form select[clrSelect],.pgpc-form textarea[clrTextarea] { width:100%; }.pgpc-form textarea[clrTextarea] { min-height:7rem; font-family:var(--clr-font-mono); font-size:.8rem; }.pgpc-form clr-control-helper { color:#6f6f6f; }.pgpc-full { grid-column:1 / -1; }.pgpc-preview { max-height:15rem; overflow:auto; margin:0; padding:.75rem; background:#f4f6f8; font-size:.75rem; }
    :host ::ng-deep .pgpc-form .clr-control-container,:host ::ng-deep .pgpc-form .clr-input-wrapper,:host ::ng-deep .pgpc-form .clr-select-wrapper,:host ::ng-deep .pgpc-form .clr-textarea-wrapper { width:100%; }
    .pgpc-delete-form { display:grid; gap:.7rem; margin-top:.5rem; }.pgpc-delete-form clr-input-container { margin:0; }
  ...
  template: `
          ...
          <article class="pgpc-target" *ngFor="let target of fleet.backupTargets()">
            <div class="pgpc-target-head">
              <span class="pgpc-target-logo" [ngClass]="backupTargetBrand(target)">
                <img *ngIf="backupTargetBrand(target)!=='generic'" [src]="backupTargetLogo(target)" [alt]="backupTargetVendorLabel(target)" />
    ...
    <clr-modal [(clrModalOpen)]="editorOpen" [clrModalClosable]="!saving">
      ...
      <div class="modal-body">
        ...
        <form clrForm clrLayout="vertical" class="pgpc-form" autocomplete="off">
          <clr-select-container><label>종류</label><select clrSelect name="profileKind" [(ngModel)]="kind" [disabled]="!!editing()"><option value="instance">인스턴스 자원</option><option value="postgres">PostgreSQL 설정</option><option value="pooling">연결 풀링</option><option value="objectStorage">백업 Object Storage</option></select></clr-select-container>
          <clr-input-container><label>이름</label><input clrInput name="profileName" [(ngModel)]="name" [disabled]="!!editing()" placeholder="orders-production" /></clr-input-container>
          <ng-container *ngIf="kind === 'instance'"><clr-input-container><label>CPU limit</label><input clrInput name="profileCpu" [(ngModel)]="cpu" placeholder="1" /></clr-input-container><clr-input-container><label>Memory limit</label><input clrInput name="profileMemory" [(ngModel)]="memory" placeholder="2Gi" /></clr-input-container><clr-input-container><label>CPU request</label><input clrInput name="profileRequestCpu" [(ngModel)]="requestCpu" placeholder="500m" /></clr-input-container><clr-input-container><label>Memory request</label><input clrInput name="profileRequestMemory" [(ngModel)]="requestMemory" placeholder="1Gi" /></clr-input-container></ng-container>
          <ng-container *ngIf="kind === 'postgres'"><clr-select-container><label>PostgreSQL 버전</label><select clrSelect name="profilePostgresVersion" [(ngModel)]="postgresVersion"><option *ngFor="let runtime of availableRuntimes()" [value]="runtime.version">PostgreSQL {{ runtime.version }} · Patroni {{ runtime.patroniVersion }}</option></select><clr-control-helper>승인된 StackGres 런타임과 exact-digest 이미지 조합입니다.</clr-control-helper></clr-select-container><clr-textarea-container class="pgpc-full"><label>postgresql.conf (한 줄에 key=value)</label><textarea clrTextarea name="profilePostgresqlConf" [(ngModel)]="postgresqlConf" placeholder="max_connections=200&#10;wal_compression=on"></textarea></clr-textarea-container></ng-container>
          <ng-container *ngIf="kind === 'pooling'"><clr-select-container><label>Pool mode</label><select clrSelect name="profilePoolMode" [(ngModel)]="poolMode"><option value="transaction">transaction</option><option value="session">session</option></select></clr-select-container><clr-input-container><label>Max client connections</label><input clrInput name="profileMaxClientConn" [(ngModel)]="maxClientConn" type="number" min="1" max="10000" /></clr-input-container></ng-container>
          <ng-container *ngIf="kind === 'objectStorage'">
            <clr-select-container class="pgpc-full"><label>External Channels 백업 대상</label><select clrSelect name="profileBackupTarget" [(ngModel)]="selectedBackupTargetId" (ngModelChange)="useBackupTarget($event)"><option value="">직접 입력</option><option *ngFor="let target of fleet.backupTargets()" [value]="target.id" [disabled]="!backupTargetReady(target)">{{ target.name }} · {{ target.bucketName }} · {{ backupTargetLabel(target) }}</option></select><clr-control-helper>Ready 상태이며 자격증명이 구성된 대상만 선택할 수 있습니다.</clr-control-helper></clr-select-container>
            ...
            <clr-select-container><label>Storage type</label><select clrSelect name="profileStorageType" [(ngModel)]="storageType"><option value="s3Compatible">S3 compatible</option><option value="s3">Amazon S3</option></select></clr-select-container><clr-input-container><label>Bucket</label><input clrInput name="profileStorageBucket" [(ngModel)]="storageBucket" placeholder="postgres-backups" /></clr-input-container><clr-input-container><label>Endpoint (S3 compatible)</label><input clrInput name="profileStorageEndpoint" [(ngModel)]="storageEndpoint" placeholder="https://s3.example.com" /></clr-input-container><clr-input-container><label>Region</label><input clrInput name="profileStorageRegion" [(ngModel)]="storageRegion" placeholder="default" /></clr-input-container><clr-input-container><label>Namespace credential Secret</label><input clrInput name="profileStorageSecretName" [(ngModel)]="storageSecretName" placeholder="backup-credentials" /><clr-control-helper>비밀값 대신 Kubernetes Secret 참조만 저장합니다.</clr-control-helper></clr-input-container><clr-input-container><label>Access key field</label><input clrInput name="profileStorageAccessKeyField" [(ngModel)]="storageAccessKeyField" placeholder="accessKeyId" /></clr-input-container><clr-input-container><label>Secret key field</label><input clrInput name="profileStorageSecretKeyField" [(ngModel)]="storageSecretKeyField" placeholder="secretAccessKey" /></clr-input-container><clr-checkbox-container><clr-checkbox-wrapper><input clrCheckbox type="checkbox" name="profileStoragePathStyle" [(ngModel)]="storagePathStyle" /><label>Path-style addressing</label></clr-checkbox-wrapper></clr-checkbox-container>
          </ng-container>
        </form>
    ...
    <clr-modal [(clrModalOpen)]="deleteOpen" [clrModalClosable]="!saving">
      ...
      <div class="modal-body"><p><strong>{{ deleting()?.name }}</strong> Profile을 삭제합니다. 이름을 정확히 입력하면 삭제가 요청됩니다.</p><form clrForm clrLayout="vertical" class="pgpc-delete-form" autocomplete="off"><clr-input-container><label>확인 이름</label><input clrInput name="deleteProfileConfirm" [(ngModel)]="deleteConfirm" /></clr-input-container></form><clr-alert *ngIf="editorError()" clrAlertType="danger" [clrAlertClosable]="false"><clr-alert-item><span class="alert-text">{{ editorError() }}</span></clr-alert-item></clr-alert></div>
...
export class PgProfileCatalogTab implements OnChanges {
  ...
  readonly availableRuntimes = computed(() => (this.fleet.runtimeCatalog()?.versions || []).filter((runtime) => runtime.lifecycle === 'Available'));
  ...
  postgresVersion = ''; postgresqlConf = 'max_connections=200\nwal_compression=on'; poolMode = 'transaction'; maxClientConn = '200'; storageType = 's3Compatible'; storageBucket = ''; storageEndpoint = ''; storageRegion = ''; storageSecretName = ''; storageAccessKeyField = 'accessKeyId'; storageSecretKeyField = 'secretAccessKey'; storagePathStyle = true; selectedBackupTargetId = '';
  deleteConfirm = '';
  ...
  backupTargetLogo(target: ExternalBackupTarget): string {
    return this.backupTargetBrand(target) === 'backblaze' ? BACKBLAZE_LOGO : CEPH_LOGO;
  }
  ...
  openEdit(profile: PostgresProfile): void {
    ...
    if (profile.kind === 'postgres') { this.postgresVersion = this.resolveRuntimeVersion(profile.spec?.postgresVersion); this.postgresqlConf = Object.entries(profile.spec?.['postgresql.conf'] || {}).map(([key, value]) => `${key}=${value}`).join('\n'); }
  ...
  openDelete(profile: PostgresProfile): void { this.deleting.set(profile); this.deleteConfirm = ''; this.editorError.set(''); this.deleteOpen = true; }
  private resetEditor(): void { this.editing.set(null); this.preview.set(null); this.editorError.set(''); this.kind = 'instance'; this.name = ''; this.cpu = '1'; this.memory = '2Gi'; this.requestCpu = '500m'; this.requestMemory = '1Gi'; this.postgresVersion = this.fleet.runtimeCatalog()?.defaultVersion || this.availableRuntimes()[0]?.version || ''; this.postgresqlConf = 'max_connections=200\nwal_compression=on'; this.poolMode = 'transaction'; this.maxClientConn = '200'; this.storageType = 's3Compatible'; this.storageBucket = ''; this.storageEndpoint = ''; this.storageRegion = ''; this.storageSecretName = ''; this.storageAccessKeyField = 'accessKeyId'; this.storageSecretKeyField = 'secretAccessKey'; this.storagePathStyle = true; this.selectedBackupTargetId = ''; }
  private resolveRuntimeVersion(version: string): string { const runtime = this.availableRuntimes().find((item) => item.version === String(version) || item.major === String(version)); return runtime?.version || this.fleet.runtimeCatalog()?.defaultVersion || ''; }
  private draft(): PostgresProfileDraft {
    const name = this.name.trim();
    if (!name) throw new Error('Profile 이름을 입력하세요.');
    if (this.kind === 'instance') return { namespace: this.namespace, kind: this.kind, name, spec: { cpu: this.cpu.trim(), memory: this.memory.trim(), requests: { cpu: this.requestCpu.trim(), memory: this.requestMemory.trim() } } };
    if (this.kind === 'postgres') {
      ...
      return { namespace: this.namespace, kind: this.kind, name, spec: { postgresVersion: this.postgresVersion.trim(), 'postgresql.conf': params } };
    }
    if (this.kind === 'pooling') return { namespace: this.namespace, kind: this.kind, name, spec: { pgBouncer: { 'pgbouncer.ini': { pgbouncer: { pool_mode: this.poolMode, max_client_conn: String(this.maxClientConn) } } } } };
    ...
    return { namespace: this.namespace, kind: this.kind, name, spec: { type: this.storageType, [this.storageType]: storage } };
  }
